...
const Doctor = () => {
  ...
  const docterData = useSelector((state) => state.doctor.doctorByHospitalData);
  ...
  useEffect(() => {
    dispatch(fetchDoctorByHospital(userLogin?.userData?._id));
  }, []);
        ...
        <div>
          {showModalDelete && (
            <DeleteDocter
              ...
              handleGetAllDocter={() => dispatch(fetchDoctorByHospital(userLogin?.userData?._id))}
